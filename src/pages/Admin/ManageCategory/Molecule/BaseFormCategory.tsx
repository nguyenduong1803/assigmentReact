    ...
    <Form onSubmit={handleSubmit(onSubmit)}>
      <Grid container spacing={3}>
        <Grid item xs={12} md={6}>
          <ControlTextField id='outlined-basic' disabled label='Category ID' name='_id' control={control} />
        </Grid>
        <Grid item xs={12} md={6}>
          <ControlTextField id='outlined-basic' label='Category Name' name='categoryName' control={control} />
        </Grid>
        <Grid item>
